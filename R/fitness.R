...
#    }
  ...
  data=readNuPoP(paste("G:/iGEM/IOfile/Rfile/temp",as.character(i),".fasta","_Prediction4.txt",sep=""),startPos=1,endPos=1024)
  ##===================裁剪positon+作图+输出图片===================
...
write.csv(list, file = "G:/iGEM/IOfile/socre.csv",quote = TRUE, 
