...
library(NuPoP)
getwd()  #ÿÿÿÿÿÿÿÿ
setwd("G:/proNuGO/IOfile") #ÿÿÿÿÿÿ`ÿÿÿÿÿÿÿÿÿÿÿ
ifile='proms.xlsx'

##===================ÿÿÿÿ+ÿÿÿÿÿÿ===================
##input = readline(prompt="ÿÿÿÿÿcsvÿÿÿÿ")
...
##ÿÿÿÿtxt
for (i in 1:len){
  write.table(read_frame[i,1], file=paste("./Rfile/temp",as.character(i),".txt",sep=""), quote=FALSE, row.names=FALSE, col.names=FALSE)
}
##ÿÿÿfasta
setwd("./Rfile")
folder = getwd()
...
for (i in 1:len){
  ...
  library(NuPoP)
  predNuPoP(file=paste("./temp",as.character(i),".fasta",sep=""),species=7,model=4)
  ...
  data=readNuPoP(paste("./temp",as.character(i),".fasta","_Prediction4.txt",sep=""),startPos=1,endPos=1112)
  ##===================ÿÿpositon+ÿÿ+ÿÿÿÿ===================
  mydata = data[c(74:1039),c(1,5)]
